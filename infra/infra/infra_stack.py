...
class InfraStackRizwan(cdk.Stack):
    ...
    def __init__(self, scope: cdk.Construct, construct_id: str, **kwargs) -> None:
        ...
        lf_alias=lambda_.Alias(self, id="alias_of_web_health", alias_name='whlf_ddd', version=web_health_lambda.current_version, provisioned_concurrent_executions=100, retry_attempts=2)
